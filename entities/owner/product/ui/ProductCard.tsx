...
import { Banknote, Clock, Timer, Trash2 } from "lucide-react";
            ...
            <div className="flex justify-between items-start">
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4 text-xs text-slate-400 font-medium">
                        <span className="flex items-center gap-1"><Clock size={12}/> {product.duration}분</span>
                    ...
                    {product.extraMinute && (
                        <p className="text-[10px] text-orange-400 font-bold bg-orange-50 px-2 py-1 rounded-lg w-fit">
                            * {product.extraMinute}분당 {product.extraPrice?.toLocaleString()}원 추가
                        </p>
                    )}
                </div>
                {onDelete && (
