              ...
              notifications.map((noti) => (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div className={`p-2 rounded-xl ${noti.type === 'checkin' ? 'bg-orange-100' :
                        noti.type === 'checkout' ? 'bg-green-100' : 'bg-blue-100'
                      }`}>
                      {noti.type === 'checkin' ? <Clock className="w-4 h-4 text-orange-600" /> :
