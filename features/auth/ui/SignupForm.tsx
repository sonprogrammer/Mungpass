        ...
        <>
            ...
            <div className="space-y-2">
                ...
                <div className="relative">
                    ...
                    <input name="name" type="text" placeholder="이름" required className="w-full pl-12 pr-4 py-4 bg-orange-50/30 border-2 border-orange-50 rounded-2xl focus:border-orange-500 focus:ring-0 outline-none font-medium text-sm transition-all" />
                </div>
            </div>
            ...
            <div className="space-y-2">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        required
                        className={`w-full pl-12 pr-28 py-4 bg-orange-50/30 border-2 rounded-2xl outline-none font-medium text-sm transition-all
                            ${emailStatus === 'taken' ? 'border-red-300' : 'border-orange-50 focus:border-orange-500'}`}
                    />
                    ...
                    <button
                        ...
                        className="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-2 bg-orange-100 text-orange-600 text-[11px] font-bold rounded-xl hover:bg-orange-200 disabled:opacity-50 transition-colors"
                    >
